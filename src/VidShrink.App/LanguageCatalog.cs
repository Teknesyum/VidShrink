...
internal static class LanguageCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, string> EnglishSource = new Dictionary<string, string>
    {
        ...
        ["• VidShrink times the sample encodes it already ran on this clip, so the speed behind this figure comes from this machine and this file rather than from a table of presets.\n• Two-pass runs get a wide range because the first pass only analyses the picture and costs less than the second, and how much less is not measured.\n• When the plan moves to settings the samples were not encoded with, the time is left blank instead of guessed."] = "• VidShrink bu klip için zaten koşturduğu örnek kodlamaların süresini ölçer; bu sayının arkasındaki hız bir ön ayar tablosundan değil, bu makineden ve bu dosyadan gelir.\n• İki geçişli işlerde aralık geniştir, çünkü birinci geçiş yalnızca görüntüyü çözümler ve ikinciden ucuza mal olur, ne kadar ucuz olduğu ise ölçülmez.\n• Plan, örneklerin kodlanmadığı ayarlara geçtiğinde süre tahmin edilmez, boş bırakılır.",
        ["Intent"] = "Amaç",
        ...
        ["• H.264 plays on essentially every device ever made and is what WhatsApp expects; pick it when the file has to just work.\n• H.265 makes files roughly a third smaller at the same picture, and every phone since about 2016 decodes it in hardware — but older handsets, some smart TVs, and several web players will not open it, and WhatsApp may re-encode it.\n• VP9 is a browser and WebM format; phones play it in apps but rarely in the gallery.\n• AV1 compresses best and is the slowest to encode, and only recent phones decode it.\n• Copy keeps the original video untouched with no quality loss and no waiting, whenever the chosen container accepts it."] = "• H.264 üretilmiş hemen her cihazda oynar ve WhatsApp'ın beklediği biçimdir; dosyanın sorunsuz çalışması gerekiyorsa bunu seçin.\n• H.265 aynı görüntüyü kabaca üçte bir daha küçük dosyada verir ve 2016 sonrası her telefon donanımda çözer — ancak eski cihazlar, bazı akıllı televizyonlar ve birkaç web oynatıcı açmaz, WhatsApp da yeniden kodlayabilir.\n• VP9 bir tarayıcı ve WebM biçimidir; telefonlar uygulamalarda oynatır ama galeride nadiren.\n• AV1 en iyi sıkıştıranıdır ve en yavaş kodlanandır, yalnızca yeni telefonlar çözer.\n• Kopyala, seçilen kapsayıcı kabul ettiğinde özgün videoyu kalite kaybı ve bekleme olmadan olduğu gibi korur.",
        ["• CRF targets visual quality, so final size can vary.\n• Fixed bitrate targets a data rate, making file size more predictable.\n• Use CRF for normal viewing quality and fixed bitrate when size or bandwidth matters more."] = "• CRF görüntü kalitesini hedefler; bu nedenle son boyut değişebilir.\n• Sabit bit hızı bir veri hızını hedefleyerek dosya boyutunu daha öngörülebilir yapar.\n• Normal izleme kalitesi için CRF, boyut veya bant genişliği daha önemliyse sabit bit hızı kullanın.",
        ["• In CRF mode, a lower number means higher quality and a larger file; 23 is a common H.264 starting point.\n• In fixed bitrate mode, enter kilobits per second: a higher value gives more quality and a larger file."] = "• CRF modunda düşük sayı daha yüksek kalite ve daha büyük dosya demektir; 23, H.264 için yaygın bir başlangıçtır.\n• Sabit bit hızı modunda saniyedeki kilobit değerini girin: yüksek değer daha fazla kalite ve daha büyük dosya verir.",
        ["• Source keeps the original dimensions.\n• A numbered option limits output height while preserving aspect ratio.\n• Lower resolution reduces file size and processing demand.\n• Custom allows an exact width and height."] = "• Kaynak özgün boyutları korur.\n• Sayılı seçenekler en-boy oranını koruyarak çıktı yüksekliğini sınırlar.\n• Düşük çözünürlük dosya boyutunu ve işlem yükünü azaltır.\n• Özel, kesin genişlik ve yükseklik girmenizi sağlar.",
        ["• Used only when resolution is custom.\n• Enter width and height as 1280x720.\n• Even dimensions are the safest choice for common video codecs."] = "• Yalnızca çözünürlük özel olduğunda kullanılır.\n• Genişlik ve yüksekliği 1280x720 biçiminde girin.\n• Yaygın video kodekleri için çift sayılı boyutlar en güvenli seçimdir.",
        ...
        ["• Preserving HDR keeps the source's wider color and brightness range, but the file is larger 10-bit and only recent devices and apps play it correctly.\n• Converting to SDR tone-maps the picture down to the standard range — smaller, and safe for WhatsApp and any phone."] = "• HDR'yi korumak kaynağın daha geniş renk ve parlaklık aralığını saklar, ancak dosya daha büyük 10-bit olur ve yalnızca yeni cihazlar ve uygulamalar doğru oynatır.\n• SDR'ye çevirmek görüntüyü standart aralığa tone-map eder — daha küçüktür ve WhatsApp ile her telefon için güvenlidir.",
        ["Fill policy"] = "Doldurma politikası",
        ["Fill target"] = "Hedefi doldur",
        ["Stay at quality ceiling"] = "Kalite tavanında dur",
        ["• Fill target lands close to the target size and squeezes out the best quality the budget allows.\n• Stay at quality ceiling stops once quality stops improving, which avoids padding the file but can leave it noticeably smaller."] = "• Hedefi doldur, hedef boyuta yakın durur ve bütçenin izin verdiği en iyi kaliteyi sıkar.\n• Kalite tavanında dur, kalite artmayı bıraktığında durur; dosyayı şişirmez ama belirgin biçimde küçük kalabilir.",
        ["Updates"] = "Güncelleme",
