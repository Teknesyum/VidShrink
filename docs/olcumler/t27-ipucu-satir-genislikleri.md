...
Ölçülen satır: **190** · tavanı aşan: **132** ·
tek kelimeyle aşan: **22**
...
| TR | MainWindow.axaml · Intent sets how early the engine stops spend… | 0 | 472 | 46 | 2 | belirler. | evet |
...
| EN | MainWindow.axaml · H.264 is the universal one: every phone made… | 0 | 847 | 421 | 3 | it. | evet |
| EN | MainWindow.axaml · H.264 is the universal one: every phone made… | 1 | 1155 | 729 | 3 | older Android phones and some web players refuse it. |  |
| EN | MainWindow.axaml · H.264 is the universal one: every phone made… | 2 | 957 | 531 | 3 | compatibility risk. |  |
| EN | MainWindow.axaml · H.264 is the universal one: every phone made… | 3 | 861 | 435 | 3 | encoding. | evet |
| TR | MainWindow.axaml · H.264 is the universal one: every phone made… | 0 | 849 | 423 | 3 | gerekmez. | evet |
| TR | MainWindow.axaml · H.264 is the universal one: every phone made… | 1 | 1179 | 753 | 3 | Android telefonlar ve bazı web oynatıcılar kabul etmez. |  |
| TR | MainWindow.axaml · H.264 is the universal one: every phone made… | 2 | 830 | 404 | 3 | seçer. | evet |
| TR | MainWindow.axaml · H.264 is the universal one: every phone made… | 3 | 856 | 430 | 3 | seçeneğini açın. |  |
...
| EN | MainWindow.axaml · Halving the frame rate frees bits for the fr… | 0 | 430 | 4 | 2 | remain. | evet |
| EN | MainWindow.axaml · Halving the frame rate frees bits for the fr… | 1 | 732 | 306 | 2 | below a level where motion starts to stutter. |  |
| EN | MainWindow.axaml · Halving the frame rate frees bits for the fr… | 2 | 693 | 267 | 2 | cost is smoothness, not compatibility. |  |
| TR | MainWindow.axaml · Halving the frame rate frees bits for the fr… | 1 | 726 | 300 | 2 | takılmaya başladığı seviyenin altına asla inmez. |  |
| TR | MainWindow.axaml · Halving the frame rate frees bits for the fr… | 2 | 572 | 146 | 2 | akıcılıktır, uyumluluk değil. |  |
| EN | MainWindow.axaml · The graphics card encodes many times faster… | 0 | 468 | 42 | 2 | processor. | evet |
| EN | MainWindow.axaml · The graphics card encodes many times faster… | 1 | 1268 | 842 | 4 | speed. | evet |
| EN | MainWindow.axaml · The graphics card encodes many times faster… | 2 | 555 | 129 | 2 | quality per megabyte. |  |
| TR | MainWindow.axaml · The graphics card encodes many times faster… | 1 | 1116 | 690 | 3 | neredeyse aynı kaliteyi yaklaşık yedi kat hızlı verir. |  |
| TR | MainWindow.axaml · The graphics card encodes many times faster… | 2 | 586 | 160 | 2 | başına bir miktar kalitedir. |  |
| EN | MainWindow.axaml · Fill target lands close to the target size a… | 0 | 660 | 234 | 2 | the best quality the budget allows. |  |
| EN | MainWindow.axaml · Fill target lands close to the target size a… | 1 | 869 | 443 | 3 | smaller. | evet |
...
| EN | MainWindow.axaml · Preserving HDR keeps the source's wider colo… | 1 | 850 | 424 | 3 | phone. | evet |
...
| TR | MainWindow.axaml · Preserving HDR keeps the source's wider colo… | 1 | 850 | 424 | 3 | güvenlidir. | evet |
...
| EN | MainWindow.axaml · H.264 plays on essentially every device ever… | 0 | 848 | 422 | 3 | work. | evet |
| EN | MainWindow.axaml · H.264 plays on essentially every device ever… | 1 | 1650 | 1224 | 5 | encode it. |  |
| EN | MainWindow.axaml · H.264 plays on essentially every device ever… | 2 | 590 | 164 | 2 | but rarely in the gallery. |  |
| EN | MainWindow.axaml · H.264 plays on essentially every device ever… | 3 | 610 | 184 | 2 | only recent phones decode it. |  |
| EN | MainWindow.axaml · H.264 plays on essentially every device ever… | 4 | 846 | 420 | 3 | it. | evet |
| TR | MainWindow.axaml · H.264 plays on essentially every device ever… | 0 | 919 | 493 | 3 | bunu seçin. |  |
| TR | MainWindow.axaml · H.264 plays on essentially every device ever… | 1 | 1551 | 1125 | 4 | açmaz, WhatsApp da yeniden kodlayabilir. |  |
| TR | MainWindow.axaml · H.264 plays on essentially every device ever… | 2 | 644 | 218 | 2 | uygulamalarda oynatır ama galeride nadiren. |  |
| TR | MainWindow.axaml · H.264 plays on essentially every device ever… | 3 | 550 | 124 | 2 | yeni telefonlar çözer. |  |
| TR | MainWindow.axaml · H.264 plays on essentially every device ever… | 4 | 768 | 342 | 2 | kalite kaybı ve bekleme olmadan olduğu gibi korur. |  |
| EN | MainWindow.axaml · CRF targets visual quality, so final size ca… | 1 | 479 | 53 | 2 | predictable. | evet |
| EN | MainWindow.axaml · CRF targets visual quality, so final size ca… | 2 | 650 | 224 | 2 | size or bandwidth matters more. |  |
| TR | MainWindow.axaml · CRF targets visual quality, so final size ca… | 0 | 469 | 43 | 2 | değişebilir. | evet |
...
| EN | MainWindow.axaml · Used only when resolution is custom. | 2 | 469 | 43 | 2 | codecs. | evet |
| TR | MainWindow.axaml · Used only when resolution is custom. | 2 | 469 | 43 | 2 | seçimdir. | evet |
| EN | MainWindow.axaml · Used only when frame rate is custom. | 2 | 497 | 71 | 2 | motion detail. |  |
| TR | MainWindow.axaml · Used only when frame rate is custom. | 1 | 432 | 6 | 2 | girin. | evet |
...
| EN | MainWindow.axaml · Audio data rate in kilobits per second. | 2 | 438 | 12 | 2 | PCM. | evet |
...
| EN | MainWindow.axaml.cs/HardwareTipEnglish · The graphics card encodes many times faster… | 0 | 468 | 42 | 2 | processor. | evet |
| EN | MainWindow.axaml.cs/HardwareTipEnglish · The graphics card encodes many times faster… | 1 | 1268 | 842 | 4 | speed. | evet |
| EN | MainWindow.axaml.cs/HardwareTipEnglish · The graphics card encodes many times faster… | 2 | 555 | 129 | 2 | quality per megabyte. |  |
| TR | MainWindow.axaml.cs/HardwareTipEnglish · The graphics card encodes many times faster… | 1 | 1116 | 690 | 3 | neredeyse aynı kaliteyi yaklaşık yedi kat hızlı verir. |  |
| TR | MainWindow.axaml.cs/HardwareTipEnglish · The graphics card encodes many times faster… | 2 | 586 | 160 | 2 | başına bir miktar kalitedir. |  |
...
| EN | MainWindow.axaml.cs/NoHardwareTipEnglish · No usable hardware encoder was found on this… | 1 | 571 | 145 | 2 | faster than the processor. |  |
...
| TR | MainWindow.axaml.cs/NoHardwareTipEnglish · No usable hardware encoder was found on this… | 1 | 469 | 43 | 2 | hızlandırır. | evet |
