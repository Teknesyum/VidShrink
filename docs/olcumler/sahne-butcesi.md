...
**Haritanin kendisi olculen 8 hucrenin 5 tanesinde kodlayiciyi geride birakmiyor** (`MAE(verilen) <= MAE(harita)`, K2 tablosu): o hucrelerde kodlayicinin kendi dagitimi haritanin onerisi kadar ya da ondan daha dogru. Bu, kazanc bulunan hucrelerle celismez, onlarin yaninda durur: dagitim parametresi tabana gore bir sey kazandirabilirken, o kazanci yoneten haritanin kendisi cogu hucrede kodlayicidan iyi degildir. Sozlesmenin "kodlayici zaten daha iyi dagitiyor" secenegi bu satirdan okunur.
