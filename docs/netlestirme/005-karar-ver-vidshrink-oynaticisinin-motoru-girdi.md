...
# Netleştirme: Karar ver: VidShrink oynaticisinin motoru icin (1) on aday kutuphaneyi AGPL-3.0 
...
Karar ver: VidShrink oynaticisinin motoru icin (1) on aday kutuphaneyi AGPL-3.0 uyumu, ikili boyutu, hiz/performans, Avalonia 11 ve airspace uyumu, basiz test, hazir ozellik kapsami, bakim ve risk sutunlariyla puanlayan tek tablo ve en mantikli secim; (2) kendi oynaticimizi yazmanin (surec ici FFmpeg.AutoGen ya da bugunku boru yolunu genisletme) GOM kapsamina maliyeti: tahmini satir, is gunu, risk, libmpv ile karsilastirmali; (3) netlestirme 004'teki libmpv + SW render kararini koruyor musun, degistiriyor musun (ornegin GPU yolu + basizda SW), gerekcesiyle.
