...
Karar ver (ucuncu tur, 009 net dondu): Avalonia 12 gecisi, major yuku, v1 kapsami, tahmin yontemi, kendi kutuphane tetigi

## Elde olan olgular

Netleştirme 009 "net" döndü: belirsizlik kalmadı. Bu tur netleştirme turu DEĞİL, karar turu. Netleştirme sorusu ya da "net" döndürme; aşağıdaki "İstenen karar" bölümünün beş maddesinin tamamını, Türkçe, tablolarla döndür. Kalan belirsizlikleri (Avalonia 11.x EOL'ü, 12'de OpenGlControlBase durumu, macOS/Linux paket yolları) karar metninde tek satırlık varsayım olarak yaz.

Olgular (netleştirme 009 ile aynı, kısaltılmadan):
