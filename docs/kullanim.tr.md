...
![Küçült sekmesi dosya yüklüyken: üstte kaynak bilgileri, hedef 17 MB'a ayarlı ve Ne Yapacak paneli seçilen kodlayıcıyı, CRF'i, çözünürlüğü ve motorun neden kalite tavanında durduğunu tek tek yazıyor](gorseller/T191-kucult-tr.png)
...
![Gelişmiş sekmesi: FFmpeg Komutu kutusu ve AI Ayarları kutusu](gorseller/T191-gelismis-tr.png)
...
![Dönüştür sekmesi: kapsayıcı, kodek, kalite kipi, çözünürlük, kare hızı ve kırpma alanları, yanlarında FFmpeg Komutu paneli](gorseller/T191-donustur-tr.png)
...
![Kaydedici sekmesi otomatik kipte: solda kaynak seçici, sağda tahmini süre ve boyut alanları ile Yeniden Ölç düğmesi, altta mikrofonu ve sistem sesini adıyla seçen Ses bölümü](gorseller/T191-kaydedici-tr.png)
