...
public sealed class OluUyeTests
{
    ...
    private static readonly PinnedFinding[] Pinned =
    {
        ...
        new("AudioCodecChoice.Aac", "varsayilan-kol", Legitimate,
            "PlanCalculator.PickAudioCodec switchinin varsayilan girisi: Ac3 ve Eac3 adiyla yaziliyor, Aac ile Auto ayni aac kolunu calistiriyor. Motordaki ayrim Auto uzerinden: PlanCalculator ExplicitAudioCodec bayragini AudioCodec != Auto ile kuruyor, Aac adiyla anilmiyor."),
