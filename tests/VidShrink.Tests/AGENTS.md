...
- `IkonKutusuTests.cs` — `Themes/Icons.axaml`'daki 27 yolun tasarım kutusu: hepsinin başında
...
- `GoruntuCekTests.cs` — kanıt karesi üretir: `.calisma/kesit-ef/` altına güncelleme panelini ve 27 simgelik
  sayfayı (dolgu diliyle) PNG olarak yazar. Ölçmez, sınamaz; tarz kararlarının resmi buradan çıkar.
