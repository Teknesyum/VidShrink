...
public sealed class BaslikKapsamiTests
{
    ...
    public void KolDegistirenAnahtarlarSayilir()
    {
        ...
        Assert.Equal(968, toplam);
        Assert.Equal(100, dilBasina["en"]);
        Assert.Equal(41, dilBasina["tr"]);
    }
    ...
    /// kolundan govde koluna gecen metinlerde (o turda 124, kirk dil eklendikten sonra 784, tagline anahtarlari silinince 778, oynatici 1. dalga anahtarlariyla 844, 3. dalga anahtarlariyla 898, 2. dalga parca anahtarlariyla 950, 4a dalga gelismis anahtarlariyla 968)
    /// ilk sozcuk disindaki <c>ffmpeg</c>
    /// dil dosyasindaki yazimiyla kaliyordu — <c>en/main.drop.hint</c>,
    /// <c>en|tr/main.reason.encoder-fallback-not-in-build</c>. Bu olcu butun dillerin butun anahtarlarinin (bugun 26617 kalem)
    ...
    /// adindan gelen bir dil daha, her biri 580 anahtar. 5. dalga ffmpeg oynatma borusunu
    ...
    /// 4a dalga 39 anahtar ekledi: 43 x 619 = 26617.</para>
    /// </summary>
    [Fact]
