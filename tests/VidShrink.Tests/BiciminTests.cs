...
public sealed class BaslikKapsamiTests
{
    ...
    /// <c>en|tr/main.reason.encoder-fallback-not-in-build</c>. Bu olcu butun dillerin butun anahtarlarinin (bugun 27563 kalem)
    ...
    /// adindan gelen bir dil daha, her biri 641 anahtar. 5. dalga ffmpeg oynatma borusunu
    ...
    /// anahtar ekledi: 43 x 641 = 27563. main.sponsor.label denendi, BrandSpellingTests ile cakisti, geri alindi.</para>
    /// </summary>
    [Fact]
