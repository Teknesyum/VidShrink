...
public sealed class BaslikKapsamiTests
{
    ...
    public void KolDegistirenAnahtarlarSayilir()
    {
        ...
        Assert.Equal(1407, toplam);
        Assert.Equal(161, dilBasina["en"]);
    ...
    /// Paket 2 kaydedicisi 80 recorder.* anahtari ekledi (Basit/Gelismis, geri sayim, cerceve, tepsi, kisayol, girdi gosterimi, webcam, buyutec ve gelismis panelin on kolu): 43 x 80 = 3440, gezilen 36507; kol degistiren toplami 1406 (en 160, tr 59). Karanlik gecis main.reason.dark-content-hevc gerekce notunu ekledi: 43 x 1 = 43, gezilen 36550; kol degistiren toplami 1407 (en 161, tr 59).</para>
    /// </summary>
    [Fact]
