...
public sealed class BaslikKapsamiTests
{
    ...
    public void KolDegistirenAnahtarlarSayilir()
    {
        ...
        Assert.Equal(967, toplam);
        Assert.Equal(103, dilBasina["en"]);
    ...
    /// kolundan govde koluna gecen metinlerde (o turda 124, kirk dil eklendikten sonra 784, tagline anahtarlari silinince 778, oynatici 1. dalga anahtarlariyla 844, 3. dalga anahtarlariyla 898, 2. dalga parca anahtarlariyla 950, 4b dalga arac anahtarlariyla 967)
    /// ilk sozcuk disindaki <c>ffmpeg</c>
    /// dil dosyasindaki yazimiyla kaliyordu — <c>en/main.drop.hint</c>,
    /// <c>en|tr/main.reason.encoder-fallback-not-in-build</c>. Bu olcu butun dillerin butun anahtarlarinin (bugun 25456 kalem)
    ...
    /// adindan gelen bir dil daha, her biri 592 anahtar. 5. dalga ffmpeg oynatma borusunu
    ...
    /// 4b dalga 12 anahtar ekledi: 43 x 592 = 25456.</para>
    /// </summary>
    [Fact]
